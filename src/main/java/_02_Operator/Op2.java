...
public class Op2 {
    ...
    public static void main(String[] args) {
        ...
        // 6. 삼항 연산자
        // boolean데이터 ? true일 때의 값 : false일 때의 값.
        int x = 100;
        int y = 10;
        int max = x > y ? x : y;
        ...
        int height = 120;
        int restrict = 150;
        String judgementRide = height >= restrict ? "탑승 가능" : "탑승 불가능";
        System.out.println(judgementRide);

        // 실습2) 50000이상이면 10퍼 할인 가격, 아니라면 원래 가격 출력
        double price = 60000.0;
        double judgementPrice = price >= 50000 ? price * 0.9 : price;
        System.out.println(judgementPrice);
